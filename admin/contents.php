...
<?php
$konular = $db->query("SELECT * FROM yazilar")->fetchAll(PDO::FETCH_ASSOC);
if ($konular) {
foreach ($konular as $x) { 
?>
<?php
...
?>
  <tbody>
    <tr>
      ...
      <td><a href="sil.php?konu_id=<?php echo $x["konu_id"]; ?>"><button class="btn btn-danger">Sil</button></a></td>
    </tr>
  </tbody>
<?php } } 
else {
echo '<center><div class="alert alert-warning" style="width:350px;" role="alert">Konu bulunamadı.</div><br></center>'; }
?>
</table></div></div>
